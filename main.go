...
func main() {
	...
	for k, ds := range cfg.Datasource {
		...
		if !(err == nil || !os.IsNotExist(err)){ 
				...
				//初始化sql语句
				initsql := "INSERT INTO `user` VALUES (2,'admin','18600000000','d060812a3a1af12643a74a4d3b6d492d','admin@qq.com','0000-00-00 00:00:00','2018-02-23 11:32:32','winlion','admin@qq.com',0,0)";
